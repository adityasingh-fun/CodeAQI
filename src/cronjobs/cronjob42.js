...
mongoose.connect('mongodb+srv://chaudharyaditya41:Z67gI1uJnrGCnHuY@cluster0.jgngtnq.mongodb.net/testingAPIsDb11?retryWrites=true&w=majority', {
    ...
    .then(() => console.log("MongoDB42 is connected"))
...
cron.schedule('4,34 * * * *', async () => {
    try {
        ...
        console.log("Coming into cronjob 42");
        // Start time of cron
        ...
        console.log("Finished Updating cron 42");
    }
    catch (error) {
