...
mongoose.connect('mongodb+srv://chaudharyaditya41:Z67gI1uJnrGCnHuY@cluster0.jgngtnq.mongodb.net/testingAPIsDb11?retryWrites=true&w=majority', {
    ...
    .then(() => console.log("MongoDB37 is connected"))
...
cron.schedule('3,33 * * * *', async () => {
    try {
        ...
        console.log("Coming into cronjob 37");
        // Start time of cron
        ...
        console.log("Finished Updating cron 37");
    }
    catch (error) {
