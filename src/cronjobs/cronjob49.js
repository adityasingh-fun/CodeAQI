...
cron.schedule('*/30 * * * *', async () => {
    try {
        ...
        for (let i = 14400; i < documents.length; i++) {
            let Status = null;
        ...
        console.log("Finished Updating cron 49");
    }
    catch (error) {
