...
mongoose.connect('mongodb+srv://chaudharyaditya41:Z67gI1uJnrGCnHuY@cluster0.jgngtnq.mongodb.net/testingAPIsDb11?retryWrites=true&w=majority', {
    ...
    .then(() => console.log("MongoDB14 is connected"))
...
cron.schedule('1,31 * * * *', async () => {
    try {
        ...
        console.log("Coming into cronjob 14");
        // Start time of cron
        ...
        console.log("Finished Updating cron 14");
    }
    catch (error) {
