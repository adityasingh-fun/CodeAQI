...
mongoose.connect('mongodb+srv://chaudharyaditya41:Z67gI1uJnrGCnHuY@cluster0.jgngtnq.mongodb.net/testingAPIsDb11?retryWrites=true&w=majority', {
    ...
    .then(() => console.log("MongoDB22 is connected"))
...
cron.schedule('2,32 * * * *', async () => {
    try {
        ...
        console.log("Coming into cronjob 22");
        // Start time of cron
        ...
        console.log("Finished Updating cron 22");
    }
    catch (error) {
